    ...
    <div className="container mx-auto bg-[#f5f2e9]">
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-12 px-6">
        ...
        <div className="bg-white shadow-md rounded-lg p-8 relative">
          {/* Decorative elements */}
          <div className="absolute top-0 right-0 p-4 text-orange-400 transform rotate-45 text-6xl">❋</div>
          <div className="absolute bottom-0 left-0 p-4 text-yellow-400 transform -rotate-45 text-4xl">✶</div>
