      ...
      <main className="container max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 py-14 px-6">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex justify-between items-center mb-8">
            <span className="bg-purple-600 text-white text-lg px-5 py-2 rounded-full">
              People Story
            </span>
          ...
          <p className="text-gray-700 leading-relaxed text-lg mb-8">
            The goal of this blog post is to inspire and suggest attractive
            clothing for young girls, ensuring comfort and style. You’ll find a
            variety of outfits that will help bring out the princess within.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <span className="bg-red-500 text-white px-4 py-2 rounded-full text-lg">
                Based Marketing
              </span>
              <p className="text-gray-700 mt-3 text-lg">
                Marketing techniques designed to capture the youth’s imagination
            ...
            <div>
              ...
              <p className="text-gray-700 mt-3 text-lg">
                Building a strong community around the children, fostering
          ...
          <div className="mb-8">
            <ul className="list-disc pl-6 text-gray-700 text-lg">
              ...
              <li>
                Encourage your child to express themselves through fashion.
              </li>
          ...
          <div className="bg-gray-100 p-8 rounded-lg mb-8">
            <blockquote className="text-gray-800 italic font-semibold text-xl">
              "Fashion for children is not just about clothes. It's about
              identity and self-expression."
              <cite className="block text-right font-normal text-lg">
                - Jane Doe, CEO
              </cite>
            </blockquote>
          </div>
          ...
          <div className="flex justify-between mt-12">
            <a href="#" className="text-gray-500 hover:text-gray-800 text-lg">
              &larr; Previous Blog
            </a>
            <a href="#" className="text-gray-500 hover:text-gray-800 text-lg">
              Next Blog &rarr;
      ...
      <section className="container mx-auto py-12 px-6">
        ...
        <form className="grid grid-cols-1 gap-8">
          ...
          <textarea
            ...
            className="border rounded-lg p-4 text-lg h-48"
          ></textarea>
