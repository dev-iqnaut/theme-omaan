...
export default function AboutUs() {
  ...
  const TestimonialCard = ({ name, role, image, text, bgColor, rating }) => (
    <div className={`relative p-6 text-white rounded-3xl ${bgColor}`}>
      ...
      {/* Bubble Tail */}
      <div className={`absolute bottom-[-20px] left-10 w-8 h-8 ${bgColor} rotate-45 rounded-[10%]`} />
  
      {/* User Information */}
      <div className="flex items-center">
        <img src={image} alt="Parent" className="w-12 h-12 rounded-full mr-4 object-cover" />
        <div>
  ...
  const Lightbulb = ({ className }) => (
    ...
    return (
      <div className="bg-[#f5f2e9] min-h-screen">
        <TopBar />
        {/* Header */}
        {/* <header className="bg-green-500 p-24 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mt-4 text-gray-600">
              Praesent aliquam ex a mauris porttitor, eget malesuada ex
              venenatis. Aenean imperdiet sodales felis, ultricies ultricies
              metus faucibus non. Integer consequat ex lacus, in mattis nulla
              posuere in. Nam posuere feugiat lacus. Morbi suscipit erat felis,
              ac aliquam nibh.
            </p>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="flex items-center space-x-4">
                ...
                <h3 className="text-l font-semibold">Tradition Of Excellence</h3>
              </div>
              ...
              <div className="flex items-center space-x-0">
                ...
                <h3 className="text-l font-semibold">Achieving High Standards</h3>
              </div>
              ...
              <div className="flex items-center space-x-0">
                ...
                <h3 className="text-l font-semibold">Partnership In Discovery</h3>
              </div>
              ...
              <div className="flex items-center space-x-0">
                ...
                <h3 className="text-l font-semibold">Foundation for the future</h3>
              </div>


            </div>

            <p className='mt-8'>Nulla pretium tincidunt ex, vehicula phareba libero suscipit quis. Vestebulum ante ipsum primis in faucibus orci iuctus et ultricir=es posteruios cubila curae. </p>
      ...
      <div className="container mx-auto px-4 py-24 relative z-10">
        <div className="flex flex-wrap justify-between items-center">
          {stats.map((stat, index) => (
            <div key={index} className="w-full md:w-1/4 text-center px-4 mb-8 md:mb-0 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        ...
        {/* Curvy arrow */}
        <svg className="absolute top-20 left-8 w-16 h-16 text-orange-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span className="absolute top-36 right-12 text-3xl font-bold text-gray-400">+</span>
        <span className="absolute bottom-24 left-16 text-3xl font-bold text-gray-400">÷</span>
        <span className="absolute top-1/2 left-8 text-3xl font-bold text-gray-400">×</span>
        ...
        <div className="space-y-10 relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between bg-[#ffa726] p-8 rounded-xl border border-dashed border-black">
            <div className="flex-1">
              ...
              <p className="text-white mt-4">
                ...
                nostra, per inceptos himenaeos. Cras quis eleifend quam. Proin
                rutrum tristique arcu. Pellentesque turpis urna, sodales sit
                amet odio eu, ultricies tincidunt tellus.
              </p>
            </div>
            <img
          ...
          <div className="flex flex-col md:flex-row items-center justify-between bg-[#42a5f5] p-8 rounded-xl border border-dashed border-black">
            <div className="flex-1">
              <h2 className="text-white text-2xl font-bold">Our Approach</h2>
              <p className="text-white mt-4">
                Class aptent taciti sociosqu ad litora torquent per conubia
                nostra, per inceptos himenaeos. Cras quis eleifend quam. Proin
                rutrum tristique arcu. Pellentesque turpis urna, sodales sit
      ...
      <div className="text-white ">
        ...
        <h1 className="text-5xl font-bold mt-4">Committed To Excellence In Education.</h1>
        <p className="mt-6 text-lg">
          Sed commodo nulla augue, in interdum turpis aliquam hendrerit. Donec fringilla scelerisque mi. Sed commodo nulla augue, in interdum turpis aliquam hendrerit. Donec fringilla scelerisque mi.
        </p>
      ...
      <div className="w-1/2 flex justify-center items-center">
        <div className="relative">
          <img src={blog2} alt="Children smiling" className="rounded-lg shadow-lg" />
        </div>
      </div>
    </div>
      ...
      <h2 className="text-green-600 text-3xl uppercase mb-10">Our Programs</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 w-full max-w-6xl">
        ...
        <div className="bg-[#FBE8E8] p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-sm">
            An inspired approach to education and life-long learning. Be nice.
            Work hard. Be safe. Be kind. Be smart. Bringing Excellence To
            Students.
          </p>
        </div>
        ...
        <div className="bg-[#FBE8E8] p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-sm">
            Creating Our Children’s Future. Dedicated To Excellence. Dedicated
            to the growth of young children. Dedicated to individuality.
          </p>
        </div>
        ...
        <div className="bg-[#FDE8CD] p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-sm">
            Excellence in early childhood education. Expect The Best For growing
            and learning. Gather to learn. Grow Explore Discover.
          </p>
        </div>
      </div>
    </div>
  ...
  <div className="relative z-10 flex flex-col items-center">
    ...
    <p className="text-gray-600 text-center max-w-xl mx-auto mb-12">
      Curabitur Finibus Odio Ac Lectus Semper Vestibulum Sit Amet Vel Ligula. Pellentesque Posuere
      Diam Id Ultrices Cursus. Integer Ipsum Arcu, Rutrum Ac Quam Quis, Vulputate Efficitur Sem.
      Duis Eget Condimentum Odio. Nulla Vel Fermentum Tellus.
    </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 w-full max-w-7xl p-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg text-center border-dashed border-2 border-gray-300">
        ...
        />
        <h3 className="text-lg font-bold text-pink-500">GEORGE TIMOTHY</h3>
