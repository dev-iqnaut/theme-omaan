      ...
      <main className="container max-w-7xl mx-auto p-6 flex flex-wrap">
        ...
        <div className="w-full lg:w-2/3 pr-0 lg:pr-10 mt-14">
          ...
          <p className="text-lg mb-6">
            ...
            porta dui sit amet ligula elementum finibus augue. Vestibulum ante
          ...
          <div className="flex flex-wrap justify-between mb-10">
            {[
              ...
              "Partnering in Discovery",
              "Achieving High Standards",
              "Foundation for the Future",
            ].map((aspect, index) => (
              <div
                key={index}
                className="w-1/2 md:w-1/4 flex items-center mb-6"
              >
        ...
        <div className="w-full lg:w-1/3 mt-14 lg:mt-14">
          ...
          <div className="bg-green-500 text-white p-8 rounded-lg mb-10">
            ...
            <ul className="space-y-3 text-lg">
              <li>
                <strong>Start Date:</strong> August 15, 2023
              </li>
              <li>
              ...
              <li>
                <strong>Age:</strong> 5-12 Years
              </li>
              <li>
                <strong>Class Size:</strong> 20 Students
              </li>
              <li>
                <strong>Fee:</strong> $199
              </li>
              <li>
