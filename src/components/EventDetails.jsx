  ...
  return (
    <div className="bg-cream-100 min-h-screen bg-[#f5f2e9]">
      ...
      <main className="container max-w-7xl mx-auto p-6 md:px-8 md:py-10">
        {/* Event Image */}
        <img src={details6} alt="Children at event" className="w-full h-96 object-cover rounded-lg mb-8" />
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 mb-6">
            Suspendisse dignissim, velit sed mattis ultricies, orci quam auctor odio, convallis facilisis diam elit pellentesque massa. Curabitur porta dui sit amet ligula elementum finibus augue.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <img src={course1} alt="Event 1" className="w-full h-48 object-cover rounded-lg" />
          <div className="bg-purple-600 rounded-lg p-6 flex flex-col justify-between">
            <h3 className="text-xl font-bold text-white">Join In Our Community Event</h3>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-6">Guiding The Young Generation</h2>
          <p className="text-gray-600 mb-6">
        ...
        <div className="flex flex-wrap  justify-between items-center mb-12">
          <div className="w-1/5 p-2">
            <div className="h-24 flex items-center justify-center">
              <img src={details1} alt="Recycling Logo" className="h-20 object-contain" />
            </div>
          </div>
          <div className="w-1/5 p-2">
            <div className="h-16 flex items-center justify-center">
              <img src={details5} alt="Heroes Logo" className="h-24 w-32 object-contain" />
            </div>
          </div>
          <div className="w-1/5 p-2">
            <div className="h-16 flex items-center justify-center">
              <img src={details4} alt="Creativity Logo" className="h-24 w-32 object-contain" />
            </div>
          </div>
          <div className="w-1/5 p-2">
            <div className="h-16 flex items-center justify-center">
              <img src={details2} alt="Eye Pop Logo" className="h-24 w-32 object-contain" />
            </div>
          </div>
          <div className="w-1/5 p-2">
            <div className="h-16 flex items-center justify-center">
              <img src={details3} alt="Kids Health Logo" className="h-32 w-60 object-contain" />
            </div>
          </div>
        </div>
      </main>
