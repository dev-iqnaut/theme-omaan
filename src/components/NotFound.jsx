  ...
  return (
    <div className="min-h-screen bg-pink-400 flex flex-col items-center justify-center text-white mt">
      ...
      <div className="relative mt-28">
        <div className="text-[200px] font-bold text-yellow-300 relative z-10">
          404
        </div>
      ...
      <p className="text-center max-w-md mb-8">
        Proin non eros elementum, sagittis diam at, feugiat nunc. Ut velit arcu,
        posuere at neque quis, vestibulum vehicula dui. Praesent at felis ante.
        Cras sed ultricies risus. Nullam porta fermentum egestas. Praesent quis
        mauris ultrices.
      </p>
